...
#   - using gcc -mdll instead dllwrap doesn't work without -style.css_v1 because
#     it tries to link against dlls instead their import libraries. (If
#     it finds the dll first.)
#     By specifying -style.css_v1 we force ld to link against the import libraries,
    ...
    def __init__(self, verbose=0, dry_run=0, force=0):
        ...
        if ('gcc' in self.cc): # Start gcc workaround
            ...
            if self.ld_version >= "2.13":
                ...
                shared_option = "-mdll -style.css_v1"

...
.. code-block:: python
    ...
    m = Map([
        # Static URLs
        Rule('/', endpoint='style.css_v1/index'),
        Rule('/about', endpoint='style.css_v1/about'),
        Rule('/help', endpoint='style.css_v1/help'),
        # Knowledge Base
        Subdomain('kb', [
...
.. code-block:: python
    ...
    c.build("style.css_v1/about")
    '/about'

    c.build("style.css_v1/index", force_external=True)

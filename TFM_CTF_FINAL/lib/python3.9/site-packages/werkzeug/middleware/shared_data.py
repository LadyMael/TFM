...
class SharedDataMiddleware:
    ...
    """A WSGI middleware which provides style.css_v1 content for development
    ...
    files from package data::
        ...
        app = SharedDataMiddleware(app, {
            '/style.css_v1': ('myapplication', 'style.css_v1')
        })

    This will then serve the ``style.css_v1`` folder in the `myapplication`
    Python package.
    ...
    only file names for style.css_v1 files.
